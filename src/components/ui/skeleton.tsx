...
function ThreadOptions({ threadCount }: { threadCount: number }) {
  return (
    <div className="space-y-4">
      {[...Array(threadCount)].map((_, i) => (
        <div
          key={i}
          className="border-2 border-dpro-primary rounded-3xl p-4 animate-pulse"
        >
...
export { Skeleton, ThreadsSkeleton, ThreadOptions };
